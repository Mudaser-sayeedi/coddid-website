...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 border ${
        scrolled
          ? "[background:var(--card-bg)] backdrop-blur-[16px] [-webkit-backdrop-filter:blur(16px)] border-border shadow-lg shadow-black/10"
